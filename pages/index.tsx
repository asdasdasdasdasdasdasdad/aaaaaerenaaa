...
export default function Home() {
  ...
  return (
	...
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossOrigin="anonymous"></link>
        <title>SOLANA CLUB PENGUIN</title>
        <link rel="shortcut icon" href="https://solanapenguin.club/images/favicon1.png"/>
      ...
      <div className="flex flex-col items-center min-h-screen mx-6">
        <Toaster />
        <div className="flex items-center justify-between w-full mt-3 menu-container">
          <h1 className="text-2xl font-bold title"><img src="https://solanapenguin.club/images/coollogo_com-59802.png" width="300"/></h1>
        ...
        {connected && (
          <p className="mr-auto text-sm">
            ...
            {500-nftsData.itemsRedeemed}/{nftsData.itemsRedeemed}/
            500
          </p>
        )}
                  ...
                  {isSoldOut ? (
                    ...
                    <>
                      <div className="flex flex-col w-1/2">
                        <h1 className="mb-10 text-3xl font-bold text-center">Mint One</h1>
                        <button
                          onClick={startMint}
                          disabled={isMinting}
                          className="px-4 py-2 mx-auto font-bold text-white transition-opacity rounded-lg hover:opacity-70 bg-gradient-to-br from-green-300 via-blue-500 to-purple-600"
                      ...
                      <div className="flex flex-col w-1/2">
                        <h1 className="mb-10 text-3xl font-bold text-center">Mint Many</h1>
                        <MintMany />
                      </div>
                    </>
                  )}
